...
import { getOrders, getOrderById, getOrderProductSnapshots, getOrderCompletionReport, getOrderSummaryReport, createOrder, updateOrder, deleteOrder, updateWarehouseDetails } from './order.controller.js'
...
router.get('/:id', authorize(['ADMIN', 'PLANNER', 'OPERATOR'], 'orders:read'), getOrderById)
