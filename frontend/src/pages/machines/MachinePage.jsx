        ...
        <DialogContent className="max-w-md p-0 overflow-hidden border-zinc-200 rounded-2xl">
          <form onSubmit={rhfHandleSubmit(onSubmit)}>
            ...
            <div className="p-6 space-y-5 bg-white">
                ...
                <Controller name="factory_id" control={control} render={({ field }) => (
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant="outline" className="w-full h-11 justify-between text-xs font-bold border-zinc-200 rounded-xl hover:border-indigo-300 hover:bg-white transition-all">
                        <div className="flex items-center gap-2 overflow-hidden text-ellipsis">
                           <Factory className="h-4 w-4 text-zinc-400" />
                           {factories?.find(f => String(f.id) === String(field.value))?.name || "Chọn nhà máy..."}
                        </div>
                    ...
                    <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0 shadow-2xl border-zinc-100 rounded-xl overflow-hidden" align="start">
                      <Command>
                         <CommandInput placeholder="Tìm nhanh nhà máy..." className="h-10" />
                         <CommandList>
                            <CommandEmpty className="py-4 text-center text-[10px] font-black text-zinc-400 uppercase tracking-widest">Không có dữ liệu</CommandEmpty>
                            <CommandGroup>
              ...
              <div className="space-y-2">
                <Label className="text-xs font-black uppercase text-zinc-400 tracking-widest">Công suất tiêu chuẩn (Sản phẩm/Giờ)</Label>
              ...
              <div className="flex items-center gap-3 p-3 bg-zinc-50 rounded-xl border border-zinc-100">
                ...
                <Label htmlFor="is_active" className="text-xs font-black text-zinc-700 uppercase cursor-pointer">Sẵn sàng vận hành</Label>
              </div>
            </div>
