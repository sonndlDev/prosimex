...
export default function FactoryPage() {
    ...
    const handleOpen = (factory = null) => {
        if (factory) {
            ...
            setFormData({ name: factory.name, is_active: factory.is_active });
        } else {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (selectedFactory) {
            updateMutation.mutate({ id: selectedFactory.id, payload: formData });
        } else {
        ...
        <Box>
            ...
            <Dialog open={openModal} onClose={handleClose} fullWidth maxWidth="sm">
                <form onSubmit={handleSubmit}>
                    <DialogTitle>{selectedFactory ? 'Chỉnh sửa nhà máy' : 'Thêm nhà máy mới'}</DialogTitle>
