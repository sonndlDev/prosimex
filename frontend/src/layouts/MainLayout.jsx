...
const menuItems = [
  ...
  { text: "Phiếu SX hàng ngày", icon: ClipboardList, path: "/daily-tickets", permission: "planning" },
  { text: "Nhập sản lượng", icon: ClipboardCheck, path: "/production-output", permission: "planning" },
  { text: "Lịch sản xuất", icon: GanttChartSquare, path: "/schedule", permission: "schedule" },
